...
int main(int argc, const char * argv[]) {
	vector<vector<string>> items{ { "M416","10" },{ "AWM", "15" },{ "FRAG GRANADE","7" } ,{ "AKM","12" },{"SHOTGUN","5"} }; //item pool
	...
	char option; // pilihan main lagi atau tidak
	int i=0;//inventory system loop
	...
	}while(option='y');//end of inventory system loop
